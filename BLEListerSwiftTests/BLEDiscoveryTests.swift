...
class BLEDiscoveryTests: XCTestCase {
    ...
    func testPostDidRefresh () {
        ...
        let expectation = XCTNSNotificationExpectation(name: NSNotification.Name(rawValue: BLEDiscovery.Notification.didRefresh.rawValue),
                                                       object: shared,
    ...
    func testPostPoweredOff () {
        ...
        // XCTNSNotificationExpectation is fulfilled iff notification is posted
        let expectation = XCTNSNotificationExpectation(name: NSNotification.Name(rawValue: BLEDiscovery.Notification.statePoweredOff.rawValue),
                                                       object: shared,
                                                       notificationCenter: ncDefault)
